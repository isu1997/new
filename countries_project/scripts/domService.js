...
const getHeartStatus = (countryName) => {
    return localStorage.getItem(`heart_${countryName}`);
}

const setHeartStatus = (countryName, className) => {
    localStorage.setItem(`heart_${countryName}`, className);
}
...
const generateCard = (country) => {
    ...
    const savedStatus = getHeartStatus(country.name.common);
    heartIcon.className = savedStatus || "fa fa-heart text-dark";
    ...
    heartIcon.addEventListener('click', () => {
        ...
        setHeartStatus(country.name.common, heartIcon.className);
    });
